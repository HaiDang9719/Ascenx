...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>"><img class="img-responsive" src="/KTproj/usersc/images/logo1.png" alt="" /></a>
		...
		<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-right">
			<ul class="nav navbar-nav ">
				<?php if($user->isLoggedIn()){ //anyone is logged in?>
					...
					<li class="hidden-md hidden-lg"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><b class="caret"></b></a></a><ul class="dropdown-menu nav navbar-nav" id="Nav1">
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=USA"> GDC </a></li>
						...
						<li ><a href="/KTproj/users/warehouseTemplate.php?WHName=USA"> GDC </a></li>
