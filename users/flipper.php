  ...
  <div class="container" style="background-color: white">
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Flipper at <?php echo $warehouseName ?> <!--?php echo $vale["p4"]?--> </strong></p>
      </div>
    </div>
            ...
            function newRangeSelected()
{
  ...
  $.getJSON({
            type: "POST",
            url: 'flipperDataService1.php',
            data:

            {
            WHName:"<?php echo $warehouseName;?>",
            Range: RangeValue
            },
