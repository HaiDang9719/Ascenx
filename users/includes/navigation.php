...
$warH = substr($currentUrl, strpos($currentUrl, "?") + 1);
...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>" ><i class="fa fa-home fa-4x" aria-hidden="true" ></i></a>
		...
		<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-right">
			<ul class="nav navbar-nav ">
				<?php if($user->isLoggedIn()){ //anyone is logged in?>
					...
					<li class="hidden-sm hidden-md hidden-lg"><a class="menu" href="#" data-toggle="dropdown"></a></a><ul class="menu nav navbar-nav" id="Nav1">
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=USA"> UDC </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Amsterdam"> Amsterdam </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Israel"> Israel </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Taiwan_TN"> Taiwan-TN </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Taiwan_HSC"> Taiwan-HSC </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Seoul"> SEOUL </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Tokyo"> Tokyo </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Osaka"> Osaka </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Fukuoka"> Fukuoka</a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Dublin"> Dublin </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Singapore"> Singapore </a></li>
                        <li role="presentation"><a href="/KTproj/users/warehouseTemplate.php?WHName=Shanghai">Shanghai </a></li>
                        </ul>
                    </li>
					 <!-- Common for Hamburger and Regular menus link -->
						<li class="dropdown hidden-xs"><a class="dropdown-toggle" href="#" data-toggle="dropdown" style="white-space: nowrap;">ESS<b class="caret"></b></a></a><ul class="dropdown-menu hidden-xs">
						<li ><a href="/KTproj/users/warehouseTemplate.php?WHName=USA"> UDC </a></li>
                        <li ><a href="/KTproj/users/warehouseTemplate.php?WHName=Amsterdam"> Amsterdam </a></li>
                        <li ><a href="/KTproj/users/warehouseTemplate.php?WHName=Israel"> Israel </a></li>
                        <li ><a href="/KTproj/users/warehouseTemplate.php?WHName=Taiwan_TN"> Taiwan-TN </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Taiwan_HSC"> Taiwan-HSC </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Seoul"> SEOUL </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Tokyo"> Tokyo </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Osaka"> Osaka </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Fukuoka"> Fukuoka </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Dublin"> Dublin </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Singapore"> Singapore </a></li>
                        <li><a href="/KTproj/users/warehouseTemplate.php?WHName=Shanghai">Shanghai </a></li>
					</ul>
					</li>
					...
					<?php if (checkMenu(2,$user->data()->id)){  //Links for permission level 2 (default admin) ?>
						...
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/admin_flippers.php"><i class="fa fa-fw fa-cog"></i>Flipper Settings</a>
						</li> <!-- Hamburger menu link -->
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/admin_warehouses.php"><i class="fa fa-fw fa-cog"></i>Depot Settings</a>
						</li> <!-- Hamburger menu link -->
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/warehouseTemplate_edit_multidrag.php?<?=$warH?>"><i class="fa fa-fw fa-cog"></i>WarehouseTemplate Edit</a>
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>map_edit.php"><i class="fa fa-fw fa-cog"></i>Map Edit</a>
						</li> <!-- Hamburger menu link -->
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/notificationSetting.php"><i class="fa fa-fw fa-cog"></i>Notification Settings</a>
						</li>
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/cameraSetting.php"><i class="fa fa-fw fa-cog"></i>Camera Settings</a>
						<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>users/statistics.php"><i class="fa fa-fw fa-cog"></i>Statistics</a>
						</li>
					...
					<li class="dropdown hidden-xs "><a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-fw fa-cog"></i><b class="caret"></b></a> <!-- regular user menu -->
						...
						<li><a href="<?=$us_url_root?>users/admin_flippers.php"><i class="fa fa-fw fa-cog"></i>Flipper Settings</a></li>
						<li><a href="<?=$us_url_root?>users/admin_warehouses.php"><i class="fa fa-fw fa-cog"></i>Depot Settings</a></li>
						<li><a href="<?=$us_url_root?>users/warehouseTemplate_edit_multidrag.php?<?=$warH?>"><i class="fa fa-fw fa-cog"></i>WarehouseTemplate Edit</a></li>
						<li><a href="<?=$us_url_root?>map_edit.php"><i class="fa fa-fw fa-cog"></i>Map Edit</a></li>
						<li><a href="<?=$us_url_root?>users/notificationSetting.php"><i class="fa fa-fw fa-cog"></i>Notification Settings</a>
						<li><a href="<?=$us_url_root?>users/cameraSettings.php"><i class="fa fa-fw fa-cog"></i>Camera Settings</a></li>
						<li><a href="<?=$us_url_root?>users/statistics.php"><i class="fa fa-fw fa-cog"></i>Statistics</a></li>
...
<script type="text/javascript" src="/KTproj/usersc/includes/navigation_script.js?n=1"></script>
