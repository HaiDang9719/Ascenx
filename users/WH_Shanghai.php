  ...
  <div class="container" style="background-color: white">
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Warehouse Location: Shanghai  <!--?php echo $vale["p4"]?--> </strong></p>
      </div>
    </div>
    ...
    <div class="row" style="background-color: white">
                <div class=" col-md-2 col-xs-4 col-sm-2 ">   
                  <div class="btn-group-vertical">
                      <button style="height:40px;width:50px;background-color: #3385ff" type="button" class="btn " id="button_control_HV" >S1</button>
                        <div class="dropdown">
