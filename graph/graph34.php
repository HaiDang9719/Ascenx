...
$que = "SELECT 4STATION_RFID_2 FROM data2 WHERE time =(SELECT MAX(time) FROM data2)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station 34 </strong></p>
