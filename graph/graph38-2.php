...
$que = "SELECT 4STATION_RFID_1 FROM data2 WHERE time =(SELECT MAX(time) FROM data2)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station 38 - ES 800 CH2 </strong></p>
