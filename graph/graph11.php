...
$que = "SELECT 5STATION_RFID_2 FROM data WHERE time =(SELECT MAX(time) FROM data)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station <?php echo $vale["s2_5"]?> of SDCS <?php echo $vale["p2"]?> </strong></p>
...
<div id="boxdiv">
    <form>
    <p>ID of Electron Source: <?php echo $row['5STATION_RFID_2']?> </p> 
