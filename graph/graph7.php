...
$que = "SELECT 1STATION_RFID_2 FROM data WHERE time =(SELECT MAX(time) FROM data)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station <?php if ($location == "Taiwan_HSC"){echo "5";}else if ($location == "Seoul"){echo "5 - ES 800 HV1";}else {echo "7";}?> </strong></p>
...
<div id="boxdiv">
    <form>
    <p>ID of Electron Source: <?php echo $row['1STATION_RFID_2']?> </p> 
    <input type="button" value="Return to Warehouse" onclick="window.location.href='<?php if ($location == "USA"){echo("http://119.17.254.105/KTproj/warehouseUSA.php?location=$location");}
