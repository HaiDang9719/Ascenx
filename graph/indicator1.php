...
$pressure = $yeah['1STATION_P2_1'];
$pressure1 = $yeah['1STATION_P1_1'];
$rfid_tag = $yeah['1STATION_RFID_1'];
...
else if($rfid_tag != "0 0 0 0 "&& $sdcs1 == 0)
{
