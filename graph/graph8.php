...
$que = "SELECT 2STATION_RFID_2 FROM data WHERE time =(SELECT MAX(time) FROM data)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station <?php if ($location == "Taiwan_HSC"){echo "6 - ES 800 CH1";}else if ($location == "Seoul"){echo "6 - ES 800 HV2";}else {echo "8";}?> </strong></p>
...
<div id="boxdiv">
    <form>
    <p>ID of Electron Source: <?php echo $row['2STATION_RFID_2']?> </p> 
    <input type="button" value="Return to Warehouse" onclick="window.location.href='<?php 
    if ($location == "USA"){echo("http://119.17.254.105/KTproj/warehouseUSA.php?location=$location");}
    if ($location == "Israel"){echo "http://119.17.254.105/KTproj/israel.php?location=$location";}
    if ($location == "Amsterdam"){echo "http://119.17.254.105/KTproj/amsterdam.php?location=$location";}
    if ($location == "Seoul"){echo "http://119.17.254.105/KTproj/seoul.php?location=$location";}
    if ($location == "Shanghai"){echo "http://119.17.254.105/KTproj/shanghai.php?location=$location";}
    if ($location == "Taiwan_HSC"){echo "http://119.17.254.105/KTproj/taiwan-hsc.php?location=$location";}
    if ($location == "Taiwan_TN"){echo "http://119.17.254.105/KTproj/taiwan-tn.php?location=$location";}
    if ($location == "Tokyo") {echo "http://119.17.254.105/KTproj/tokyo.php?location=$location";}
    if ($location == "Osaka"){echo "http://119.17.254.105/KTproj/osaka.php?location=$location";}
    if ($location == "Singapore"){echo "http://119.17.254.105/KTproj/singapore.php?location=$location";}?>'" />
