...
$que = "SELECT 3STATION_RFID_2 FROM data WHERE time =(SELECT MAX(time) FROM data)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station <?php if ($location == "Taiwan_HSC"){echo "7 - ES 800 CH2";}else {echo "9";}?> </strong></p>
