...
$que = "SELECT 5STATION_RFID_1 FROM data WHERE time =(SELECT MAX(time) FROM data)";
$do = mysql_query($que);
...
<body>
    <p id="sitetitle" style="text-align: center; color:  #0e6889"><strong style="font-size: 200%">Station <?php if ($location == "Seoul"){echo "5 - ES 800 HV1";}else{echo "5";}?></strong></p>
...
<div id="boxdiv">
    <form>
    <p>ID of Electron Source: <?php echo $row['5STATION_RFID_1']?> </p> 
